...
if (isset($_POST['submit'])) {
  ...
  $ins_medecins=$connect->prepare("INSERT INTO laboratoire (id_labo, type_examen, observation_labo, date_examen, frais_examen, malade_id_malade) 
                                VALUES (:id_labo, :examen, :observation, :date, :frais, :malade)");
