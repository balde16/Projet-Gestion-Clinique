...
<?php
//verification si il ya une consultation en cours 
if (isset($_POST['submit'])) {
  ...
  //requete ,preparation, parametre et execution d'une consultattion 
  $ins_medecins=$connect->prepare("INSERT INTO consulte(id_malade, id_medecins, obsevation_consult, frais_consultation, date_consultation)
                                  VALUES (:malade, :medecins, :observation, :frais, :date)");
...
$cat_id = $_GET['cat_delete'];
  ...
  $stmt_delete = $connect->prepare("DELETE FROM categorie 
                             WHERE categorie.id_cat=:id");
